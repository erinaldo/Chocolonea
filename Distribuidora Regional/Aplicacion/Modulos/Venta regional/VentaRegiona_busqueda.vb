...
#End Region
                ...
                If tb_nrolote.Text <> "" Then
                    ...
                    If lote_ok = "si" Then
                        ...
                        While item < VentaRegional_nuevodiseño.DG_PRODAGREGADOS.Rows.Count
                            If VentaRegional_nuevodiseño.DG_PRODAGREGADOS.Rows(item).Cells(0).Value = DataGridView1.Rows(indice).Cells(0).Value Then
                                presente = "si"
                                fila_editar = item
                            End If
                            item = item + 1
                        ...
                        If presente = "no" Then
                            ...
                            newCustomersRow("Venta_Lote") = tb_nrolote.Text
    ...
    Private Sub Label_preciototal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label_preciototal.Click
